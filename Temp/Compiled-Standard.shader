...
Constant Buffer "VGlobals" (36 bytes) on slot 0 {
...
Constant Buffer "FGlobals" (44 bytes) on slot 0 {
  Vector4 _LightColor0 at 0
  Vector4 _Color at 16
  Float _Metallic at 32
  Float _Glossiness at 36
  Float _OcclusionStrength at 40
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    if(u_xlatb45){
        ...
        u_xlat7.xyz = fma(UnityReflectionProbes.unity_SpecCube0_BoxMin.www, u_xlat6.xyz, u_xlat17.xyz);
    }
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    u_xlat0.x = dot(UnityLighting.unity_SHBr, u_xlat1);
    u_xlat0.y = dot(UnityLighting.unity_SHBg, u_xlat1);
    u_xlat0.z = dot(UnityLighting.unity_SHBb, u_xlat1);
    output.TEXCOORD5.xyz = fma(UnityLighting.unity_SHC.xyz, float3(u_xlat6), u_xlat0.xyz);
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    u_xlat1.x = dot(UnityLighting.unity_SHBr, u_xlat2);
    u_xlat1.y = dot(UnityLighting.unity_SHBg, u_xlat2);
    u_xlat1.z = dot(UnityLighting.unity_SHBb, u_xlat2);
    output.TEXCOORD5.xyz = fma(UnityLighting.unity_SHC.xyz, float3(u_xlat10), u_xlat1.xyz);
    output.TEXCOORD5.w = 0.0;
    u_xlat0.y = u_xlat0.y * UnityPerCamera._ProjectionParams.x;
    u_xlat1.xzw = u_xlat0.xwy * float3(0.5, 0.5, 0.5);
    output.TEXCOORD7.zw = u_xlat0.zw;
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    output.TEXCOORD4.xyz = u_xlat1.xyz;
    u_xlat2 = (-u_xlat0.xxxx) + UnityLighting.unity_4LightPosX0;
    ...
    u_xlat1.xyz = fma(UnityLighting.unity_SHC.xyz, float3(u_xlat15), u_xlat2.xyz);
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    u_xlat3 = (-u_xlat1.xxxx) + UnityLighting.unity_4LightPosX0;
    u_xlat4 = (-u_xlat1.yyyy) + UnityLighting.unity_4LightPosY0;
    u_xlat1 = (-u_xlat1.zzzz) + UnityLighting.unity_4LightPosZ0;
    ...
    u_xlat1 = fma(u_xlat1, UnityLighting.unity_4LightAtten0, float4(1.0, 1.0, 1.0, 1.0));
    u_xlat1 = float4(1.0, 1.0, 1.0, 1.0) / u_xlat1;
    u_xlat3 = u_xlat3 * u_xlat4;
    u_xlat3 = max(u_xlat3, float4(0.0, 0.0, 0.0, 0.0));
    u_xlat1 = u_xlat1 * u_xlat3;
    u_xlat3.xyz = u_xlat1.yyy * UnityLighting.unity_LightColor[1].xyz;
    u_xlat3.xyz = fma(UnityLighting.unity_LightColor[0].xyz, u_xlat1.xxx, u_xlat3.xyz);
    u_xlat1.xyz = fma(UnityLighting.unity_LightColor[2].xyz, u_xlat1.zzz, u_xlat3.xyz);
    u_xlat1.xyz = fma(UnityLighting.unity_LightColor[3].xyz, u_xlat1.www, u_xlat1.xyz);
    ...
    u_xlat2.xyz = fma(UnityLighting.unity_SHC.xyz, float3(u_xlat19), u_xlat3.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat8.xyz = fma((-input.TEXCOORD1.xyz), float3(u_xlat46), UnityLighting._WorldSpaceLightPos0.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    if(u_xlatb49){
        u_xlatb5 = UnityProbeVolume.unity_ProbeVolumeParams.y==1.0;
        u_xlat20.xyz = input.TEXCOORD3.www * UnityProbeVolume.hlslcc_mtx4x4unity_ProbeVolumeWorldToObject[1].xyz;
        u_xlat20.xyz = fma(UnityProbeVolume.hlslcc_mtx4x4unity_ProbeVolumeWorldToObject[0].xyz, input.TEXCOORD2.www, u_xlat20.xyz);
        u_xlat20.xyz = fma(UnityProbeVolume.hlslcc_mtx4x4unity_ProbeVolumeWorldToObject[2].xyz, input.TEXCOORD4.www, u_xlat20.xyz);
        u_xlat20.xyz = u_xlat20.xyz + UnityProbeVolume.hlslcc_mtx4x4unity_ProbeVolumeWorldToObject[3].xyz;
    ...
    u_xlat5.x = dot(u_xlat5, UnityLighting.unity_OcclusionMaskSelector);
    ...
    if(u_xlatb49){
        ...
        u_xlat35 = fma((-UnityProbeVolume.unity_ProbeVolumeParams.z), 0.5, 0.25);
    ...
    if(u_xlatb47){
        ...
        u_xlat10.xyz = (-u_xlat4.xyz) + UnityReflectionProbes.unity_SpecCube0_BoxMax.xyz;
        u_xlat10.xyz = u_xlat10.xyz / u_xlat9.xyz;
        u_xlat11.xyz = (-u_xlat4.xyz) + UnityReflectionProbes.unity_SpecCube0_BoxMin.xyz;
        u_xlat11.xyz = u_xlat11.xyz / u_xlat9.xyz;
        u_xlatb12.xyz = (float3(0.0, 0.0, 0.0)<u_xlat9.xyz);
        {
        ...
        u_xlat47 = min(u_xlat10.y, u_xlat10.x);
        u_xlat47 = min(u_xlat10.z, u_xlat47);
        u_xlat10.xyz = u_xlat4.xyz + (-UnityReflectionProbes.unity_SpecCube0_ProbePosition.xyz);
    ...
    if(u_xlatb49){
        ...
        if(u_xlatb49){
            ...
            u_xlat12.xyz = (-u_xlat4.xyz) + UnityReflectionProbes.unity_SpecCube1_BoxMax.xyz;
            u_xlat12.xyz = u_xlat12.xyz / u_xlat11.xyz;
            u_xlat13.xyz = (-u_xlat4.xyz) + UnityReflectionProbes.unity_SpecCube1_BoxMin.xyz;
        ...
        u_xlat10.xyz = fma(UnityReflectionProbes.unity_SpecCube0_BoxMin.www, u_xlat6.xyz, u_xlat4.xyz);
    }
    u_xlat4.xyz = u_xlat5.xxx * u_xlat10.xyz;
    u_xlat6.xyz = fma((-input.TEXCOORD1.xyz), float3(u_xlat46), UnityLighting._WorldSpaceLightPos0.xyz);
    ...
    u_xlat2.x = dot(u_xlat2.xyz, u_xlat6.xyz);
    u_xlat2.x = clamp(u_xlat2.x, 0.0f, 1.0f);
    u_xlat17.x = dot(UnityLighting._WorldSpaceLightPos0.xyz, u_xlat6.xyz);
    u_xlat17.x = clamp(u_xlat17.x, 0.0f, 1.0f);
    u_xlat32 = u_xlat17.x * u_xlat17.x;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat22 = dot(u_xlat4, UnityLighting.unity_OcclusionMaskSelector);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat23 = fma(u_xlat23, u_xlat24, UnityShadows._LightShadowData.x);
    u_xlat22 = u_xlat22 + (-u_xlat23);
...
Constant Buffer "FGlobals" (128 bytes) on slot 0 {
  ...
  Vector4 _LightColor0 at 0
  Vector4 _ShadowMapTexture_TexelSize at 16
  Vector4 _Color at 32
  Float _Metallic at 48
  Float _Glossiness at 52
}
Constant Buffer "UnityPerCamera" (144 bytes) on slot 1 {
  Vector3 _WorldSpaceCameraPos at 64
}
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    output.TEXCOORD1.xyz = u_xlat2.xyz + (-UnityPerCamera._WorldSpaceCameraPos.xyzx.xyz);
    output.TEXCOORD1.w = 0.0;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat23 = u_xlat23 + (-UnityLighting._LightProjectionParams.z);
    u_xlat23 = max(u_xlat23, 9.99999975e-06);
    u_xlat23 = u_xlat23 * UnityLighting._LightProjectionParams.w;
    u_xlat23 = UnityLighting._LightProjectionParams.y / u_xlat23;
    u_xlat23 = u_xlat23 + (-UnityLighting._LightProjectionParams.x);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat25 = dot(u_xlat5, UnityLighting.unity_OcclusionMaskSelector);
    ...
    if(u_xlatb26){
        ...
        u_xlat26 = u_xlat26 + (-UnityLighting._LightProjectionParams.z);
        u_xlat26 = max(u_xlat26, 9.99999975e-06);
        u_xlat26 = u_xlat26 * UnityLighting._LightProjectionParams.w;
        u_xlat26 = UnityLighting._LightProjectionParams.y / u_xlat26;
        u_xlat26 = u_xlat26 + (-UnityLighting._LightProjectionParams.x);
        ...
        u_xlat26 = fma(u_xlat26, u_xlat27, UnityShadows._LightShadowData.x);
    } else {
        u_xlat26 = 1.0;
    }
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat22 = fma(UnityReflectionProbes.unity_SpecCube0_HDR.w, u_xlat22, 1.0);
    u_xlat22 = log2(u_xlat22);
    u_xlat22 = u_xlat22 * UnityReflectionProbes.unity_SpecCube0_HDR.y;
    u_xlat22 = exp2(u_xlat22);
    u_xlat22 = u_xlat22 * UnityReflectionProbes.unity_SpecCube0_HDR.x;
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    u_xlat3.y = dot(UnityLighting.unity_SHBg, u_xlat2);
    u_xlat3.z = dot(UnityLighting.unity_SHBb, u_xlat2);
    u_xlat2.xyz = fma(UnityLighting.unity_SHC.xyz, float3(u_xlat18), u_xlat3.xyz);
    u_xlat1.w = 1.0;
    u_xlat3.x = dot(UnityLighting.unity_SHAr, u_xlat1);
    u_xlat3.y = dot(UnityLighting.unity_SHAg, u_xlat1);
    u_xlat3.z = dot(UnityLighting.unity_SHAb, u_xlat1);
    ...
    u_xlat4 = u_xlat1.yyyy * u_xlat3;
    u_xlat3 = u_xlat3 * u_xlat3;
    u_xlat5 = (-u_xlat0.xxxx) + UnityLighting.unity_4LightPosX0;
    u_xlat0 = (-u_xlat0.zzzz) + UnityLighting.unity_4LightPosZ0;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat25 = dot(u_xlat3, UnityLighting.unity_OcclusionMaskSelector);
    u_xlat25 = clamp(u_xlat25, 0.0f, 1.0f);
    ...
    u_xlat25 = fma(UnityReflectionProbes.unity_SpecCube0_HDR.w, u_xlat25, 1.0);
    u_xlat25 = log2(u_xlat25);
    u_xlat25 = u_xlat25 * UnityReflectionProbes.unity_SpecCube0_HDR.y;
    u_xlat25 = exp2(u_xlat25);
    u_xlat25 = u_xlat25 * UnityReflectionProbes.unity_SpecCube0_HDR.x;
    ...
    u_xlat25 = u_xlat25;
    u_xlat25 = clamp(u_xlat25, 0.0f, 1.0f);
    u_xlat7.x = dot(u_xlat7.xyz, UnityLighting._WorldSpaceLightPos0.xyz);
